...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // UserInfoEntity event handlers
	sized: false,
	...
	getHTML: function(width, height) {
		...
		if (navigator.UserInfoEntityAgent.match(/MSIE/)) {
	...
	addEventListener: function(eventName, func) {
		// add UserInfoEntity event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				...
				if (!this.ready && navigator.UserInfoEntityAgent.match(/Firefox/) && navigator.UserInfoEntityAgent.match(/Windows/)) {
					self = this;
		...
		} // UserInfoEntity defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the UserInfoEntity input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the UserInfoEntity about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    UserInfoEntity to let them know what the print view is.
	...
	/**
	 * Show a message to the end UserInfoEntity which is nicely styled
	 *  @param {string} message The HTML string to show to the UserInfoEntity
	...
	/**
	 * Take the UserInfoEntity defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the UserInfoEntity options */
		...
		// Backwards compatibility - allow the UserInfoEntity to specify a custom class in the initialiser
	...
	/**
	 * Take the UserInfoEntity input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of UserInfoEntity defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end UserInfoEntity but it allows the animation to be
			...
			if ( this.s.select.type === 'os' ) {
				$(dt.nTBody).on( 'mousedown.DTTT_Select', 'tr', function(e) {
					if ( e.shiftKey ) {
						...
						$(dt.nTBody)
							.css( '-moz-UserInfoEntity-select', 'none' )
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-UserInfoEntity-select', '' );
				} );
			}
	...
	"_fnRowSelect": function ( src, e )
	{
		...
		// UserInfoEntity defined pre-selection function
	...
	"_fnNewline": function ( oConfig )
	{
		...
		{
			return navigator.UserInfoEntityAgent.match(/Windows/) ? "\r\n" : "\n";
		}
		else
		{
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the UserInfoEntity know what is happening */
		if ( oConfig.sInfo !== "" )
		{
