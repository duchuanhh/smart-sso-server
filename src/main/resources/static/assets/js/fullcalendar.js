...
function Calendar(element, instanceOptions) {
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before UserInfoEntity starts waiting for AJAX
...
Popover.prototype = {
	...
	// Triggered when the UserInfoEntity clicks *anywhere* in the document, for the autoHide feature
...
DragListener.prototype = {
	...
	// Call this when the UserInfoEntity does a mousedown. Will probably lead to startListening
	...
	// Called when the UserInfoEntity moves the mouse
	...
	// Called when the UserInfoEntity does a mouseup
	mouseup: function(ev) {
		this.stopDrag(ev);
	...
	// Call this to stop listening to the UserInfoEntity's mouse events
...
MouseFollower.prototype = {
	...
	// Gets called when the UserInfoEntity moves the mouse
	mousemove: function(ev) {
...
$.extend(Grid.prototype, {
	...
	mousedOverSeg: null, // the segment object the UserInfoEntity's mouse is over. null if over nothing
	...
	destroyEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if UserInfoEntity's mouse is over an event
	...
	// Called when the UserInfoEntity does a mousedown on an event, which might lead to dragging.
	...
	// Called when the UserInfoEntity does a mousedown on an event's resizer, which might lead to resizing.
	// Generic enough to work with any type of Grid.
...
$.extend(DayGrid.prototype, {
	...
	showSegPopover: function(date, cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the UserInfoEntity clicks elsewhere, hide the popover
...
View.prototype = {
	...
	isSelected: false, // boolean whether cells are UserInfoEntity-selected or not
	...
	// Used to determine what happens when the UserInfoEntitys clicks next/prev. Given -1 for prev, 1 for next.
	...
	// Handler for unselecting when the UserInfoEntity clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the UserInfoEntity made a proper left click?
...
$.extend(AgendaView.prototype, {
	...
	// Sets the scroll value of the scroller to the intial pre-configured state prior to allowing the UserInfoEntity to change it.
